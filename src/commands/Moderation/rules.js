...
module.exports = {
    ...
    description: "It's the rules!",
    catergory: null,
    usage: "Question",
    run: (bot, message, args) => {
   message.delete()
   let gayEMBED25 = new MessageEmbed()
   .setTitle("RULES")
   ...
   .addField("Never Ever post NSFW", "never")
    //
   .addField("Part 1", "Please show the respect that you would like to receive from other members. No harassment, discrimination, cyber-bullying, slander, or the intentional instigation of conflicts.")
